...
public class KF5ConfigManager {
	private static final Log logger = LogFactory.getLog(KF5ConfigManager.class);
	private static final String CONFIG_ACCESS_PATH = "/config/kf5.properties";
	private static final Properties Listener = new Properties();
	
	static {
		InputStream configFileIStream = KF5ConfigManager.class
